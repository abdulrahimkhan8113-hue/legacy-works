...
import projectAB from "@/assets/AB.jpg";
import projectAtta from "@/assets/atta.jpg";
import projectFaisal from "@/assets/faisal.jpg";
import projectSabir from "@/assets/sabir.jpg";
import projectsafia from "@/assets/safiaRice.jpg";
import projectPetroin from "@/assets/petroin.jpg";
...
import legacyportqasim from "@/assets/portqasim.jpg";
...
export const projects: Project[] = [
  { id: 1, title: "Multan Majestic Feed Mill", city: "Multan", image: projectBoilerSilver, year: "2019", description: "Full insulation upgrade of the Multan steam-generation plant — high-density rock wool over headers and economisers, finished with aluminium cladding for a decade-grade weather jacket." },
  { id: 2, title: "Riverside Multan", city: "Multan", image: projectDuctwork, year: "2017", description: "High-precision hot and cold thermal insulation with protective aluminium cladding across industrial facilities to optimize energy efficiency and system durability." },
  { id: 3, title: "Riverside Multan", city: "Multan", image: projectOrangeVessel, year: "2015", description: "Durable thermal insulation systems protected by heavy-duty Galvanized Iron (G.I.) sheet cladding for demanding industrial environments, ensuring maximum structural resilience and weatherproofing." },
  { id: 4, title: "FB Food & Feeds (pvt) LTD", city: "Kabirwala", image: projectBoilerBlue, year: "2018", description: "High performance thermal insulation wrapped in premium color coated sheet cladding, delivering a sleek, aesthetically polished finish alongside robust weather protection for modern industrial facilities." },
  { id: 5, title: "K.K Feed Mill", city: "Sahiwal(Sargodha)", image: projectPiping, year: "2020", description: "Durable thermal insulation systems protected by heavy-duty Galvanized Iron (G.I.) sheet cladding for demanding industrial environments, ensuring maximum structural resilience and weatherproofing." },
  { id: 6, title: "AB Feed Mill", city: "Muzaffargarh", image: projectAB, year: "2016", description: "High performance thermal insulation wrapped in premium color coated sheet cladding and Galvanized Iron (G.I.) sheet cladding, delivering a sleek, aesthetically polished finish alongside robust weather protection for modern industrial facilities." },
  { id: 7, title: "Cherat Cement Company LTD", city: "Nowshera", image: legacyChirat, year: "1984", description: "One of Tayeb & Company's earliest landmark contracts — pre-heater insulation at Chirat Cement, completed within twelve months of the firm's founding." },
  { id: 8, title: "Kohinoor Energy LTD", city: "Lahore", image: legacyKohinoor, year: "1996", description: "Sub-contract execution of the thermal insulation scope at the Kohinoor power plant under main contractor Zelin Pvt Ltd." },
  ...
  { id: 10, title: "Jutti Port Qasim", city: "Karachi", image: legacyportqasim, year: "2003", description: "Insulation systems finished with premium aluminium cladding to deliver high corrosion resistance, exceptional heat reflection, and a lightweight, durable shield for industrial piping and equipment." },
  
  { id: 12, title: "Petroin Lubricants", city: "Khudian Khaas", image: projectPetroin, year: "2008", description: "Durable thermal insulation systems protected by heavy-duty Galvanized Iron (G.I.) sheet cladding for demanding industrial environments, ensuring maximum structural resilience and weatherproofing." },
  { id: 13, title: "Faisal Feeds — Solvent Plant Insulation & Ductwork", city: "Multan", image: projectFaisal, year: "2012", description: "Insulation and duct work at the Faisal Solvent extraction plant — fabrication of GI ductwork and thermal lagging across the process train." },
  { id: 14, title: "Sabirs' Vegetable Oils — Insulation & Duct Work", city: "Sheikhupura", image: projectSabir, year: "2014", description: "Insulation and duct work for Sabirs' Vegetable Oils — combined hot insulation scope and process exhaust ducting." },
  { id: 15, title: "Atta Chemicals — Thermal Insulation", city: "Multan", image: projectAtta, year: "2017", description: "Thermal insulation across the Atta Chemicals process plant, including reactor jackets, headers and storage." },
  { id: 16, title: "Safia Rice Mills — Insulation & Ductwork", city: "Sahiwal", image: projectsafia, year: "2024", description: "Recent deployment at Safia Rice Mills covering boiler insulation and process exhaust ductwork." },
];
// Expanded city footprint — 1000+ projects across Pakistan.
// Coordinates are approximate normalised positions (x%, y%) on the SVG map.
export const cities = [
  { name: "Karachi", x: 22, y: 88, projectId: 10 },
  { name: "Multan", x: 38, y: 55, projectId: 1 },
  { name: "Sheikhupura", x: 58, y: 43, projectId: 14 },
  { name: "Lahore", x: 62, y: 40, projectId: 8 },
  { name: "Gujrat", x: 56, y: 33, projectId: 9 },
  { name: "Nowshera", x: 50, y: 20, projectId: 7 },
  { name: "Sahiwal(Sargodha)", x: 45, y: 36, projectId: 5 },
  { name: "Sahiwal", x: 49, y: 48, projectId: 16 },
  { name: "Kabirwala", x: 43, y: 58, projectId: 4 },
  { name: "Muzaffargarh", x: 32, y: 59, projectId: 6 },
  { name: "Khudian Khaas", x: 54, y: 50, projectId: 12 },
];
...
export const team = [
  ...
  { name: "Shan Zulfiqar", role: "Chief Operating Officer", bio: "Leads company operations and client partnerships while upholding the Tayeb Standard across every project." },
