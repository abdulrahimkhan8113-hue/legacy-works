        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {featured.map((p, i) => (
            ...
            >
              <button
                onClick={() => setActive(p)}
                className="group w-full touch-action-manipulation overflow-hidden rounded-2xl border border-border bg-card text-left transition-all hover:border-copper/50 hover:shadow-glow [touch-action:manipulation]"
              >
